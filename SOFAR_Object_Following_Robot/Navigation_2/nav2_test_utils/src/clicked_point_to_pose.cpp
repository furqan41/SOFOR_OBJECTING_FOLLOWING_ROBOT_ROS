...
// Code program which sends the coordinates of the goal published in the /clicked_point topic to the behavior tree. 
// Anytime you update the goal to reach by clicking a different position of the environment with your mouse, the ClickedPointToPose class subscribes the chosen point position on the /clicked_point topic and it publishes it on the /goal_update topic. 
